/* tslint:disable */
export function RadarChart(d3, id, data, options) {
    const cfg = {
        ...
        color: (i) => d3.cat10[i]  //Color function
    };
    ...
    const allAxis = (data[0].map(function(i, j) { return i.axis })),  //Names of each axis
        ...
        Format = cfg.formatter,         //Percentage formatting
    ...
    blobWrapper.selectAll('.radarCircle')
        ...
        .style('fill', (d, i, j) => { return cfg.color(d.ix); })
        .style('stroke', 'white')
